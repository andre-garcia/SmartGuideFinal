        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            if (
              ...
              html = html.replaceAll("<br>", "");
              // botResponse = `<img class="botAvatar" src="./static/img/botAvatar_old.png"/><span class="botMsg">${html}</span><div class="clearfix"></div>`;
              botResponse = getBotResponse(html);
            } else {
...
function customActionTrigger() {
  $.ajax({
    url: "https://action-server-smartguide-andre-garcia.cloud.okteto.net/webhook/",
    type: "POST",
    contentType: "application/json",
    data: JSON.stringify({
